...
| Route estimated time | Google route estimate action | `input_snapshot.routeEstimate.*DurationMinutes`, `googleRouteDurationHuman`, `googleRouteDurationQuarterHours` | App provider estimate | Route Intelligence API/provider layer | Calculator route intelligence panel and planning suggestions | UI displays human-readable duration and 0.25-hour planning context | CONNECTED |
