...
const dateInputField = z.preprocess(toDateInputValue, z.string());
const timeInputField = z.preprocess(toTimeInputValue, z.string());
...
const routeStopSchema = z.object({
  ...
  appointmentDate: dateInputField.default(""),
  appointmentTime: timeInputField.default(""),
  appointmentWindowStartDate: dateInputField.default(""),
  appointmentWindowStart: timeInputField.default(""),
  appointmentWindowEndDate: dateInputField.default(""),
  appointmentWindowEnd: timeInputField.default(""),
...
export const loadInputSchema = z.object({
  ...
  pickupDate: dateInputField.default(""),
  pickupTime: timeInputField.default(""),
  pickupWindowStartDate: dateInputField.default(""),
  pickupWindowStart: timeInputField.default(""),
  pickupWindowEndDate: dateInputField.default(""),
  pickupWindowEnd: timeInputField.default(""),
  pickupWindowOpenEnded: z.boolean().optional().default(false),
  pickupDwellHours: quarterHourField.refine((value) => value >= 0).default(2),
  deliveryDate: dateInputField.default(""),
  deliveryTime: timeInputField.default(""),
  deliveryWindowStartDate: dateInputField.default(""),
  deliveryWindowStart: timeInputField.default(""),
  deliveryWindowEndDate: dateInputField.default(""),
  deliveryWindowEnd: timeInputField.default(""),
  ...
  deadheadStartDate: dateInputField.default(""),
  deadheadStartTime: timeInputField.default(""),
  deadheadEndDate: dateInputField.default(""),
