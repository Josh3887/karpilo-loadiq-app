  ...
  return (
    <div className="fixed bottom-4 right-4 z-[70] flex max-w-[calc(100vw-2rem)] items-end gap-3 sm:bottom-6 sm:right-6">
      ...
      <button
        type="button"
        onClick={onOpen}
        className="atlas-signal-shell group relative flex min-w-0 items-center gap-3 rounded-2xl border border-sky-400/35 bg-[#06101F]/95 px-4 py-3 text-left shadow-[0_18px_60px_rgba(8,47,73,0.42)] backdrop-blur-xl transition hover:border-sky-300/60 hover:bg-[#07182A]"
        aria-label="Open Atlas educational signal"
        aria-expanded={panelOpen}
      >
        <span className="atlas-scan-ring absolute -inset-1 rounded-[1.15rem] border border-sky-300/20" />
