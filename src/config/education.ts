...
export const OVERHEAD_CATEGORY_HELP = {
  ...
  compliance:
    "Permits, ELD, drug consortium, filings, and safety/compliance services fit here. Advanced jurisdictional fuel-tax estimation belongs only under Pro estimation.",
  dispatchFactoring:
