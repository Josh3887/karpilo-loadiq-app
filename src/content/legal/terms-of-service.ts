...
export const TERMS_SECTIONS: LegalSection[] = [
  {
    ...
    paragraphs: [
      ...
      "By creating an account, using the app, accepting legal acknowledgements, starting a subscription, or saving operational data, users agree to use LoadIQ responsibly and according to these Terms.",
    ],
  },
  {
    id: "decision-support",
    ...
    paragraphs: [
      "LoadIQ provides estimates, calculations, comparisons, warnings, and operational intelligence based on user inputs, configured profile assumptions, available reference data, and app logic.",
      "LoadIQ does not guarantee profitability, freight availability, revenue, margin, settlement accuracy, fuel cost, lane performance, route cost, business success, or operational outcome.",
    ],
  },
  {
    id: "no-advice",
    ...
    paragraphs: [
      "LoadIQ is not financial advice, legal advice, accounting advice, tax advice, dispatch advice, regulatory advice, investment advice, insurance advice, safety advice, or a substitute for professional judgment.",
  ...
  },
  {
    ...
    paragraphs: [
      "Users may not misuse LoadIQ, interfere with service operations, attempt unauthorized access, scrape or reverse engineer protected systems, resell access without permission, upload unlawful content, submit fraudulent billing information, abuse refund systems, or use the app to harm others.",
  ...
  },
  {
    ...
    paragraphs: [
      "LoadIQ may use public or third-party data sources for fuel references, routing, weather, mapping, tolling, compliance context, or future operational intelligence. These sources may be delayed, incomplete, revised, unavailable, or inaccurate.",
      "LoadIQ may experience downtime, degraded performance, maintenance windows, third-party outages, network issues, API failures, deployment errors, or platform restrictions. No uninterrupted availability is promised.",
    ],
  },
  {
    id: "ip",
    ...
    paragraphs: [
      ...
      "Users may not copy, clone, resell, misrepresent, decompile, or exploit LoadIQ intellectual property except as permitted by law or a written agreement.",
    ],
  },
  {
    id: "no-warranty",
    title: "No Warranties",
    paragraphs: [
      "LoadIQ is provided on an as-is and availability-dependent basis. To the fullest extent permitted by law, Karpilo Endeavor Technologies LLC disclaims warranties of accuracy, reliability, fitness for a particular purpose, merchantability, uninterrupted availability, and profitability results.",
    ],
  },
  {
    id: "liability",
